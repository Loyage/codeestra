export const phase1SchemaVersion = 16;
 ...
 *
 * Schema version 16 is reserved for this migration. Versions 13/14/15 belong to the concurrent
 * lanes; every `version <` step is kept and runs in ascending order.
 */
