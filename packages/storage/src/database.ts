  ...
  private migrate(): void {
    ...
    try {
      this.sqlite.transaction(() => {
        ...
        // Version 23 is the Task-retry step (ADR-0036); version 22 belongs to the reservation
        // snapshot-generation lane. A database stamped 17–21 still gets both, in order.
