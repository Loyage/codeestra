  ...
  private migrate(): void {
    ...
    try {
      this.sqlite.transaction(() => {
        ...
        // Version 20 belongs to the parallel impact snapshot lane (E1); this step only ever adds
        // its own number, so a database stamped 17–20 still gets the capacity/slot tables.
