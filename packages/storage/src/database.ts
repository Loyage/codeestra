  ...
  private migrate(): void {
    ...
    try {
      this.sqlite.transaction(() => {
        ...
        // Version 26 is this step's own number, so a database stamped 24 or 25 still gets the
        // Project Knowledge tables. Version 25 belongs to a parallel lane and is not inserted here;
        // version 16 stays permanently unused. No earlier number is ever inserted.
