...
export const eventEnvelopeSchema = z.strictObject({
  ...
  /**
   * `null` for a Runtime-global fact (ADR-0061 D10, schema v34): a global capacity or pause decision
   * is not any one Project's event. A Project-filtered subscriber receives those too, because they
