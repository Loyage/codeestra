...
Status：Accepted；**Amended by ADR-0011**：以默认 FULL 零确认替代“保留现有门禁”；**Amended by ADR-0070**：把笼统的“Runtime 是服务”细化为 0 号根 Service + Runtime 内持久 Service/Process/Signal 内核。CLI 完备与测试边界不变。
