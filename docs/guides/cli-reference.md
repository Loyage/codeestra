...
> **适用版本** ADR-0068 S1–S4（2026-09-17） · **schema** v37 · **最后校对** 2026-09-17
...
> 拆分说明（ADR-0063）：原来这一篇 1322 行的参考按功能拆分；ADR-0068 S4 新增 Service Kernel 参考，现在 [`cli/`](./cli/README.md) 下共九篇。
...
| ADR-0068 S4 `service` / `process` / `signal` / `intent`（无旧 §N） | [cli/kernel.md](./cli/kernel.md) |
