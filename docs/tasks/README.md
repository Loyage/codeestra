...
## FOUNDATION-077 — ADR-0047 的产品实现：经 GitHub 中转的稳定提升（schema v29 / ADR-0050）
...
| E ADR | ADR-0050：命令面事实分层（可重试拒绝 vs `STALE`、`AWAITING_PULL` 与退出码 3、推回失败可续、`DEV_REPO_*` 口径） | `docs/decisions/0050-promotion-fact-layering.md`、`docs/decisions/README.md` |
...
### 关键实现决定（ADR 未写、本格写进 ADR-0050 的部分）
...
11. ~~**ADR-0047 的产品实现**~~ **已完成（FOUNDATION-077 / schema v29 / ADR-0050）**：`promotion prepare/approve/promote`
