...
try {
  if (commandId === 'status') {
  ...
  } else if (commandId === 'service.list') {
  ...
  } else if (commandId === 'service.tree') {
  ...
  } else if (commandId === 'service.state') {
  ...
  } else if (commandId === 'process.list') {
    const split = splitFlagTokens([firstArgument, ...remainingArguments]
  ...
  } else if (commandId === 'process.get') {
    if (firstArgument === undefined || remainingArguments.some((token) => token !== '--json')) usage();
    print(await call({ command: 'process.get', processId: firstArgument }));
  } else if (commandId === 'process.input') {
    ...
    print(result);
  } else if (commandId === 'process.pause' || commandId === 'process.terminate') {
  ...
  } else if (commandId === 'signal.get') {
    if (firstArgument === undefined || remainingArguments.some((token) => token !== '--json')) usage();
    print(await call({ command: 'signal.get', signalId: firstArgument }));
  } else if (commandId === 'signal.retry') {
    if (firstArgument === undefined || remainingArguments.some((token) => token !== '--json')) usage();
